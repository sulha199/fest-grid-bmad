...
export interface StatusBadgeProps {
  variant: "active" | "invalid" | "pending" | "upheld" | "dismissed" | "pendingReview" | "accepted" | "reverted" | "expired" | "superseded" | "removedByModeration" | "hiddenByMe" | "lowConfidence" | "classificationFailed";
  label: string;
}
