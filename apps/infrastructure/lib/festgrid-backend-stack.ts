  ...
  constructor(scope: Construct, id: string, props: FestgridBackendStackProps) {
    ...
    const notifierLambda = new nodejs.NodejsFunction(this, `NotifierLambda-${stageName}`, {
      ...
      environment: {
        ...
        SCRAPER_PROVIDER_ALERT_THRESHOLD_DAYS: process.env.SCRAPER_PROVIDER_ALERT_THRESHOLD_DAYS || '2',
        SCRAPER_PROVIDER_ALERT_COOLDOWN_DAYS: process.env.SCRAPER_PROVIDER_ALERT_COOLDOWN_DAYS || '3',
        SECRETS_SYNCED_AT: secretsSyncedAt,
      },
    });
