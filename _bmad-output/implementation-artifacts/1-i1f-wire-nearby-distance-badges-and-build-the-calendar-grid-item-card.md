...
- [x] **Task 8 — Full verification (all ACs)**
  ...
  - [x] 8.2 `packages/ui`'s full Vitest suite passes (554/554 tests, 55 files, after all 2026-09-20 revisions — see Change Log) — no regression in `EventCard`/`WeeklyCalendarView`/`useWeeklyCalendarController`/`useCurrentLocationCapture` or any other suite.
