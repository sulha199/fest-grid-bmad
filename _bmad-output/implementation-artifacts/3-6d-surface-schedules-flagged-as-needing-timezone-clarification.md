...
- [ ] **Task 1: GraphQL schema surface** (AC: 1, 2, 4, 5) — `apps/backend/src/schema/events.graphql`
...
- [ ] **Task 2: Shared IANA timezone validator** (AC: 4) — `packages/domain/src/users/` (new subfolder)
...
- [ ] **Task 3: `resolveScheduleTimezone` resolver** (AC: 2, 4, 5) — `apps/backend/src/schema/resolvers.ts`
...
- [ ] **Task 4: Backend integration tests** (AC: 2, 3, 4, 5) — new `apps/backend/src/schema/schedule-timezone.test.ts`, mirroring `favorites-and-calendar.test.ts`'s real-local-DB harness
...
- [ ] **Task 5: Frontend GraphQL operation documents** (AC: 1, 5) — `apps/web/src/features/events/`
...
- [ ] **Task 6: `EventDetailView` component (packages/ui)** (AC: 1, 2, 6) — `packages/ui/src/features/events/`
...
- [ ] **Task 7: Wire into `apps/web`** (AC: 2, 3, 5, 6) — `apps/web/src/features/events/`
...
- [ ] **Task 8: i18n** (AC: 6) — `apps/web/locales/en.json`, `id.json`
...
- [ ] **Task 9: Frontend integration tests** (AC: 1, 2, 3, 5) — `apps/web/src/features/events/EventDetailWrapper.test.tsx` (existing file, extend)
...
- [ ] **Task 11: Full verification** (Global)
