...
- [ ] Task 3: Build the reusable `WeeklyCalendarView` primitive (Story 1.3g — verify done, do not re-implement here)
  - [ ] Confirm Story 1.3g (`1-3g-build-the-reusable-weeklycalendarview-component`) is `done` before starting Task 4. If not yet done, this story cannot be completed end-to-end — see Pre-Coding Approval Gate.
